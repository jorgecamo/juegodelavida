...
# Constantes
ANCHO = int(input("Dime el ancho"))   # Ancho de la cuadrícula
ALTO = int(input("Dime el alto"))  # Alto de la cuadrícula

VIVO = input("Dime un caracter para la celula viva")  # Carácter para la celda viva
